...
const getIceServers = () => {
    ...
    try {
        ...
        console.log("Invalid VITE_ICE_SERVERS, falling back to default STUN.");
    }
...
export default function VideoMeetComponent() {
    ...
    const upsertRemoteVideo = (socketListId, stream) => {
    ...
    const attachLocalStreamToConnection = (pc, stream) => {
        if (!pc || !stream) return;

        if (pc.getSenders && pc.addTrack) {
    ...
    let getUserMediaSuccess = (stream) => {
        ...
        for (let id in connections) {
            ...
            attachLocalStreamToConnection(connections[id], window.localStream)
            ...
            socketRef.current.on('user-joined', (id, clients) => {
                clients.forEach((socketListId) => {
                    ...
                    connections[socketListId].ontrack = (event) => {
                        ...
                        if (remoteStream) {
                            upsertRemoteVideo(socketListId, remoteStream);
                        }
                    };
                    ...
                    if (window.localStream !== undefined && window.localStream !== null) {
                        attachLocalStreamToConnection(connections[socketListId], window.localStream)
                    } else {
                        let blackSilence = (...args) => new MediaStream([black(...args), silence()])
                        window.localStream = blackSilence()
                        attachLocalStreamToConnection(connections[socketListId], window.localStream)
                ...
                if (id === socketIdRef.current) {
                    for (let id2 in connections) {
                        ...
                        try {
                            attachLocalStreamToConnection(connections[id2], window.localStream)
                        } catch (e) { }
        ...
        <div className="videoMeetPage">
            ...
            {askForUsername === true ?
                ...
                <div className="lobbyContainer">
                    ...
                    <h2>Meet Up Lobby</h2>
                    <p>Enter your name and connect to start the call.</p>
                ...
                <div className="meetVideoContainer">
                    <div className="meetTopBar">
                        <h2>Meet Up Video Call</h2>
                    </div>
                        ...
                        <div className="chatContainer">
                            ...
                            <div className="chattingDisplay">
                                ...
                                {messages.length !== 0 ? messages.map((item, index) => {
                                    ...
                                    return (
                                        <div className="chatMessageItem" key={index}>
                    ...
                    <div className="buttonContainers">
                        ...
                        <IconButton className="controlBtn endCallBtn" onClick={handleEndCall} style={{ color: "red" }}>
                            <CallEndIcon  />
                        </IconButton>
                        ...
                        {screenAvailable === true ?
                            <IconButton className="controlBtn" onClick={handleScreen} style={{ color: "white" }}>
